...
class afarea_render : public node::listener_t, public resource::new_property_listener, public property_listener
{
...
public:
	/*constructor*/			afarea_render			();
	/*destructor*/			~afarea_render			();
